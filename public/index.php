...
//Dapatkan Tanggal Hari Ini
	$today = date("Y-m-d");
	$get_tiket_pesawat = $core->get_tiket_by_date_type($today, 1);
	$get_tiket_kereta = $core->get_tiket_by_date_type($today, 2);

//Dapatkan Carousel
	$carousel_img = $carousel->carousel();
// Acak Tulisan Carousel
...
<body>
	...
	<!--LIST TIKET-->
	<div>
		<a href="list-tiket-pesawat.php" class="tiket-home tiket-pesawat-home blue darken-2 hoverable tooltipped" data-position="top" data-tooltip="List Tiket Pesawat Terbang">
		<div>
			<i class="fa fa-plane icon-home-fix"></i>
		</div>
		</a>
		<a href="list-tiket-kereta.php" class="tiket-home tiket-kereta-home green darken-3 hoverable tooltipped" data-position="top" data-tooltip="List Tiket Kereta Api">
		<div>
			<i class="fa fa-train"></i>
		</div>
		</a>
		<a href="#" class="tiket-home tiket-order-home hoverable tooltipped" data-position="top" data-tooltip="Jadwal Keberangkatan">
		<div>
	...
	<div class="slider">
		<ul class="slides">
			<?php while ($img_c = $carousel_img->fetch_assoc()){ ?>
			<li>
				<img src="asset/database/img/<?php echo $img_c['img_src']; ?>" alt="">
				<div class="caption center-align">
					<h2><?php echo $img_c['ket']; ?></h2>
					<h4 class="light black-text text-lighten"><?php echo $img_c['ket2']; ?></h4>
				</div>
			</li>
			<?php } ?>
		</ul>
	...
	<!--LIST KEBERANGKATAN SEGERA-->
	<!--PESAWAT-->
	<br>
	<br>
	<h3>&nbsp;&nbsp;KEBERANGKATAN HARI INI (<?php echo date("d/m/Y"); ?>) : </h3>
	<?php while ($pesawat = $get_tiket_pesawat->fetch_assoc()){ ?>
		<div class="hoverable">
	<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
				<br>
				<b>To</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><i><?php echo $pesawat['tujuan']; ?></i></b>&nbsp;&nbsp;
				<br>
				<b>Routes</b> : <b><i><?php echo $pesawat['rute_awal']; echo " - "; echo "row_pesawat['rute_akhir']"; ?></i></b>&nbsp;&nbsp;
				<br>
				<b>Price</b> &nbsp;&nbsp;&nbsp;&nbsp;: <b><i>Rp. <?php echo $pesawat['harga']; ?></i></b>&nbsp;&nbsp;
				<a href="detail-tiket.php?id=<?php echo $pesawat['id_rute']; ?>" style="float: right; margin-right: 20px;">Detail..</a>
		</div>
		<div class="card-custom-icon blue darken-2 inline-card white-text card-custom-icon-fix">
			<!--UNTUK ICON PESAWAT-->
			<h6 class="tgl-fix"><b><?php echo $pesawat['tgl_keberangkatan']; ?></b></h6>
			<h6 class="status-fix"><b><?php echo $pesawat['status_keberangkatan']; ?></b></h6>
		</div>
	</div>
		<br>
		<br>
	...
	<!--KERETA-->
	<?php while ($kereta = $get_tiket_kereta->fetch_assoc()){ ?>
		<div class="hoverable"><
	<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
			<br>
				<b>To</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><i><?php echo $kereta['tujuan']; ?></i></b>&nbsp;&nbsp;
				<br>
				<b>Routes</b> : <b><i><?php echo $kereta['rute_awal']; echo " - "; echo $kereta['rute_akhir']; ?></i></b>&nbsp;&nbsp;
				<br>
				<b>Price</b> &nbsp;&nbsp;&nbsp;&nbsp;: <b><i>Rp. <?php echo $kereta['harga']; ?></i></b>&nbsp;&nbsp;
				<a href="#detail-tiket.php?id=<?php echo $kereta['id_rute']; ?>" style="float: right; margin-right: 20px;">Detail..</a>
		</div>
		<div class="card-custom-icon green darken-3 inline-card white-text">
			<!--UNTUK ICON KERETA-->
			<h6 class="tgl-fix"><b><?php echo $kereta['tgl_keberangkatan']; ?></b></h6>
			<h6 class="status-fix"><b><?php echo $kereta['status_keberangkatan']; ?></b></h6>
		</div>
		</div>
		<br>
		<br>
	<?php 
			...
			if ($get_tiket_pesawat->fetch_assoc() === NULL && $get_tiket_kereta->fetch_assoc() === NULL)
			{
	?>
		
		<div class="card-fix card-custom-ket-2 text-list-berangkat-1 inline-card hoverable">
			<br>
			<center><h5><b><i>Tidak Ada Keberangkatan Hari Ini</i></b></h5></center>
		</div>
		...
		<div>
			<form action="config/c-proses.php" method="POST">
				<div class="input-field col s6">
					<input type="text" name="username" id="username" class="validate" required="required" autocomplete="off">
		...
		<div>
			<div>
				<div class="img-profile">
					<img src="asset/database/img-profil/<?php echo $id_img['img_src']; ?>" alt="Your Profile" class="img-profile-size">
				</div>
