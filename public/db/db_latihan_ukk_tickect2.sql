...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2019 at 01:22 AM
...
INSERT INTO `rute` (`id_rute`, `tujuan`, `rute_awal`, `rute_akhir`, `harga`, `status_keberangkatan`, `id_transportasi`) VALUES
(1, 'MAKASSAR', 'BANDARA SENTANI', 'BANDARA HASANUDDIN', 2700000, 'Malam', 1),
(2, 'DOK V BAWAH', 'APO - GOR', 'DOK V BAWAH - SMK N 1', 8000, 'Pagi', 2),
(3, 'JAYAPURA', 'BANDARA HASANUDDIN', 'BANDARA SENTANI', 2500000, 'Sore', 1),
(4, 'JAYAPURA', 'BANDARA HASANUDDIN', 'BANDARA SENTANI', 2500000, 'Pagi', 1),
(5, 'SURABAYA', 'BANDARA SENTANI', 'BANDARA JUANDA', 2700000, 'Malam', 1),
(6, 'DOK IX', 'APO - GOR', 'DOK V BAWAH - DOK IX', 8000, 'Pagi', 2);
