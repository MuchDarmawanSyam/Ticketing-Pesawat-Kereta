...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2019 at 08:32 PM
...
(1, 'CAROUSEL_IMG_15334949349052047.jpg', 'PHP', 'Slide 1'),
(2, 'CAROUSEL_IMG_15334949731637112.jpg', 'Javascript', 'Slide 2'),
(3, 'CAROUSEL_IMG_15334949833842544.jpg', 'Phyton', 'Slide 3'),
(4, 'CAROUSEL_IMG_15334950143211427.jpg', 'Ruby', 'Slide 4'),
(5, 'CAROUSEL_IMG_15334950301279403.jpg', 'Java', 'Slide 5');
...
(16, 'testu', 'testu', 'MuchU', 'repU', '2019-01-21', 'L', '87878780', 8780, 2),
(17, 'u', 'u', 'sas', 'asas', '2019-01-15', 'L', '88989', 0, 1),
(18, 'q', 'q', 'a', 'aa', '2002-01-01', 'L', '8', 0, 1),
...
--
ALTER TABLE `cart_tiket`
  MODIFY `id_cart_tiket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `img_profil_penumpang`
  MODIFY `id_img_profil_penumpang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
