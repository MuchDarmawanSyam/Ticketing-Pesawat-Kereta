...
<body>
	...
	<div class="filter-fix">
		<form action="" method="POST">
			...
			<div class="form-filter2 inline-filter">
				To :
				<select name="filter_to" style="display: block;">
					<option value="All">All</option>
	...
	<!--FUNGSI FILTER LIST KEBERANGKATAN-->
	<?php  
		if (isset($_POST['btnFilter'])) 
		{
			...
			if ($filter_status !== 'All' && $filter_to !== 'All')
			{

				$filter_data = $filter->filter_route($filter_status, $filter_to);
	?>
			<h4 class="title-tiket-fix">Tiket Filtered by <b><?php echo $filter_status; ?></b> And <b><?php echo $filter_to; ?></b> :</h4>
				<?php  
					while ($row_pesawat = $filter_data->fetch_assoc())
					{
				?>
					<div class="hoverable hoverable-fix">
					<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
							...
							<a href="detail-tiket.php?id=<?php echo $row_pesawat['id_rute']; ?>" style="float: right; margin-right: 20px;">Detail..</a>
					</div>
	...
	<?php  
			...
			{
				$filter_data_status = $filter->filter_route_status($filter_status);

	?>

				<h4 class="title-tiket-fix">Tiket Filtered by <b><?php echo $filter_status; ?></b> And <b><?php echo $filter_to; ?></b> :</h4>
				<?php  
					while ($row_pesawat = $filter_data_status->fetch_assoc())
					{
				?>
					<div class="hoverable hoverable-fix">
					<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
	...
	<?php  
			...
			elseif ($filter_to !== 'All')
			{
				$filter_data_to = $filter->filter_route_to($filter_to);

	?>

				<h4 class="title-tiket-fix">Tiket Filtered by <b><?php echo $filter_status; ?></b> And <b><?php echo $filter_to; ?></b> :</h4>
				<?php  
					while ($row_pesawat = $filter_data_to->fetch_assoc())
					{
				?>
					<div class="hoverable hoverable-fix">
					<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
	...
	?>
			...
			<h4 class="title-tiket-fix">Tiket Kereta :</h4>
			<?php  
				while ($row_kereta = $kereta->fetch_assoc()){
			?>
			<div class="hoverable">
				<div class="card-fix card-custom-ket text-list-berangkat-1 inline-card">
					<br>
						<b>To</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><i><?php echo $row_kereta['tujuan']; ?></i></b>&nbsp;&nbsp;
						<br>
						<b>Routes</b> : <b><i><?php echo $row_kereta['rute_awal']; echo " - "; echo $row_kereta['rute_akhir']; ?></i></b>&nbsp;&nbsp;
						<br>
						<b>Price</b> &nbsp;&nbsp;&nbsp;&nbsp;: <b><i>Rp. <?php echo $crud_pt->formal_price($row_kereta['harga']); ?></i></b>&nbsp;&nbsp;
						<a href="detail-tiket.php?id=<?php echo $row_kereta['id_rute']; ?>" style="float: right; margin-right: 20px;">Detail..</a>
				</div>
				<div class="card-custom-icon green darken-3 inline-card white-text">
					<!--UNTUK ICON KERETA-->
					<h6 class="tgl-fix"><b><?php echo $row_kereta['tgl_keberangkatan']; ?></b></h6>
					<h6 class="status-fix"><b><?php echo $row_kereta['status_keberangkatan']; ?></b></h6>
				</div>
				</div>
				<br>
				<br>
	<?php  
		...
		{
	?>
				<h3><b>Tiket Yang Difilter Tidak Tersedia</b></h3>
	<?php
		}
	?>
